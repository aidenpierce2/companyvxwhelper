...
class MyFragmentBean(var headImgUrl: String, var nickName: String, var userPhone: String, var rightDrawable : Drawable?, var functionBean: Array<FunctionItemBean>) : BaseEntity(){
